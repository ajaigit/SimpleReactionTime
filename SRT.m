...
close all  
warning('off','all');
addpath('C:\Ajai\Simple_Reaction_Time\dependecies');
...
plot(DisplayWindowAxes,1, 1.3 , '.', 'MarkerSize',1000,'Color',[0.8500 0.3250 0.0980]);
...
%         cla(DisplayWindowAxes)
   ...
   % else
        ...
        TxtHndl = text(1,1,'Ready','FontSize',100,'Color',[0.4660 0.6740 0.1880],'FontWeight','bold') ;
        set(DisplayWindowAxes,'visible','off','xlim',[0 2],'ylim',[0 2],'Position',[0 0 1 1]) ;
        set(TxtHndl,'visible','on','HorizontalAlignment','center','VerticalAlignment','middle');
        ...
        Chndl = plot(DisplayWindowAxes,1, 1, '.', 'MarkerSize',1000,'Color',[0.8500 0.3250 0.0980]);
        set(DisplayWindowAxes,'visible','off','xlim',[0 2],'ylim',[0 2],'Position',[0 0 1 1]) ;
        waitforbuttonpress;
...
RandTimeMatrix = randi([1000,1500],TestReps,1);
...
function BasicWaitBar2(RP,DisplayWindowAxes)
    ...
    TxtHndl = text(1,1,'Relax','FontSize',100,'Color',[0.6350 0.0780 0.1840],'FontWeight','bold') ;
    set(DisplayWindowAxes,'visible','off','xlim',[0 2],'ylim',[0 2],'Position',[0 0 1 1]) ;
    set(TxtHndl,'visible','on','HorizontalAlignment','center','VerticalAlignment','middle');
